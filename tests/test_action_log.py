"""Tool-trail notes and action log formatting for solver tracing."""
...
def test_notes_drop_error_prose_without_trail():
    note = notes_from_actions(["bash: ls"], prose="Error: boom")
    assert note == ""


def test_notes_skip_accept_spam_without_trail():
    note = notes_from_actions(
