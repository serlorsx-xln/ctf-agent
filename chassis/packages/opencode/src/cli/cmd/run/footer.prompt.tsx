...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const placeholder = createMemo(() => {
    ...
    return new StyledText([fg(input.theme().muted)('Ask anything... "Solve ./challenges/foo"')])
  })
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Artemis" } satisfies SlashOption,
    ]
