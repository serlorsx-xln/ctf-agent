...
export interface DialogSelectProps<T> {
  ...
  current?: T
  /** When set, header esc click calls this instead of clearing the dialog immediately. */
  onEscape?: () => void
}
    ...
    <box gap={1} paddingBottom={1} flexGrow={1}>
      <box paddingLeft={4} paddingRight={4}>
        <box flexDirection="row" justifyContent="space-between">
          ...
          <text fg={theme.textMuted} onMouseUp={() => (props.onEscape ? props.onEscape() : dialog.clear())}>
            esc
          </text>
        </box>
